...
$js_dir = array_diff(scandir(ROOT_PATH.'/js/build'), array('..', '.'));
foreach ($js_dir as $js_file) {
  $js_minifier->add(ROOT_PATH.'/js/build/' . $js_file);
}

// Minify CSS
$css_minifier = new CSSminifierExtended();
$css_dir = array_diff(scandir(ROOT_PATH.'/css/build'), array('..', '.'));
foreach ($css_dir as $css_file) {
  $css_minifier->add(ROOT_PATH.'/css/build/' . $css_file);
}
